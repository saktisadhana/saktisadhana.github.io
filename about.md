...
- **CTF Competitions** — Capture The Flag events across web exploitation, cryptography, and forensics
- **Security Research** — Exploring vulnerabilities, tools, and methodologies
- **Systems Programming** — C, Rust, operating systems, and low-level code
